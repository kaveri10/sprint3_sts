...
public class UserEntity {
		...
		public UserEntity(long userId, String emailId, String name, LocalDate dob, String password, Long phoneNo,
				String address, String univName, int attempts, String role) {
			super();
			this.userId = userId;
			this.emailId = emailId;
			this.name = name;
